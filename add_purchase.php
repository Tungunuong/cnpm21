...
<body>
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('bar-chart', 'Nhập Thuốc', 'Nhập Thuốc Từ NCC');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        ...
        <div class="row col col-md-12">
          ...
          <div class="col col-md-4 form-group">
            <label class="font-weight-bold" for="suppliers_name">Nhà Cung Cấp :</label>
            <input id="suppliers_name" type="text" class="form-control" placeholder="Tên Nhà Cung Cấp" name="suppliers_name" onkeyup="showSuggestions(this.value, 'supplier');">
          ...
          <div class="col col-md-2 form-group">
            <label class="font-weight-bold" for="">Số Hóa Đơn :</label>
            <input type="number" class="form-control" placeholder="Mã Số Hóa Đơn" id="invoice_number" name="invoice_number" onblur="notNull(this.value, 'invoice_number_error'); checkInvoice(this.value, 'invoice_number_error');">
          ...
          <div class="col col-md-2 form-group">
            <label class="font-weight-bold" for="invoice_date">Ngày Tháng :</label>
        ...
        <div class="row col col-md-12">
          ...
          <div class="col col-md-2 form-group float-right">
            <label class="font-weight-bold" for="">Tổng :</label>
        ...
        <div class="row col col-md-12">
          ...
          <div class="col col-md-2 form-group">
            <button class="btn btn-primary form-control" onclick="addPurchase();">THÊM</button>
          </div>
          <div class="col col-md-5"></div>
        </div>
        <!-- closing button -->
