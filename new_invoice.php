...
<body>
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('clipboard', 'Tạo Đơn Hàng', 'Tạo Đơn Hàng Mới');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        ...
        <div class="row col col-md-12">
          <div class="col col-md-3 form-group">
            <label class="font-weight-bold" for="customers_name">Tên khách hàng :</label>
            <input id="customers_name" type="text" class="form-control" name="customers_name" onkeyup="showSuggestions(this.value, 'customer');">
          ...
          <div class="col col-md-3 form-group">
            <label class="font-weight-bold" for="customers_address">Địa chỉ :</label>
            <input id="customers_address" type="text" class="form-control" name="customers_address" disabled>
          </div>
          <div class="col col-md-2 form-group">
            <label class="font-weight-bold" for="invoice_number">Mã đơn hàng :</label>
            <input id="invoice_number" type="text" class="form-control" name="invoice_number" disabled>
          </div>
          <div class="col col-md-2 form-group">
            <label class="font-weight-bold" for="">Thanh toán :</label>
            <select id="payment_type" class="form-control">
              <option value="1">Trả tiền trực tiếp</option>
              <option value="2">Trả tiền trực tuyến</option>
            
            </select>
          </div>
          <div class="col col-md-2 form-group">
            <label class="font-weight-bold" for="">Ngày tháng :</label>
        ...
        <div class="row col col-md-12">
          <div class="col col-md-2 form-group">
            <button class="btn btn-primary form-control" onclick="document.getElementById('add_new_customer_model').style.display = 'block';">Tạo khách hàng mới</button>
          </div>
          <div class="col col-md-1 form-group"></div>
          <div class="col col-md-2 form-group">
            <label class="font-weight-bold" for="customers_contact_number">Số điện thoại :</label>
            <input id="customers_contact_number" type="number" class="form-control" name="customers_contact_number" disabled>
          </div>
        </div>
        ...
        <div class="row col col-md-12">
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-2">Mã thuốc</div>
            <div class="col col-md-1">ID</div>
            <div class="col col-md-1">Hạn sử dụng</div>
            <div class="col col-md-1">Số lượng</div>
            <div class="col col-md-1">MRP</div>
            <div class="col col-md-1">Giảm giá(%)</div>
            <div class="col col-md-1">Tổng</div>
            <div class="col col-md-2">Hành động</div>
          </div>
        </div>
        <div class="col col-md-12">
        ...
        <div class="row col col-md-12">
          ...
          <div class="col col-md-2 form-group float-right">
            <label class="font-weight-bold" for="">Tổng tiền:</label>
            <input type="text" class="form-control" value="0" id="total_amount" disabled>
          </div>
          <div class="col col-md-2 form-group float-right">
            <label class="font-weight-bold" for="">Giảm giá :</label>
            <input type="text" class="form-control" value="0" id="total_discount" disabled>
          </div>
          <div class="col col-md-2 form-group float-right">
            <label class="font-weight-bold" for="">Tổng thực :</label>
        ...
        <div class="row col col-md-12">
          <div id="save_button" class="col col-md-2 form-group float-right">
            ...
            <button class="btn btn-success form-control font-weight-bold" onclick="addInvoice();">Lưu</button>
          </div>
          <div id="new_invoice_button" class="col col-md-2 form-group float-right" style="display: none;">
            <label class="font-weight-bold" for=""></label>
            <button class="btn btn-primary form-control font-weight-bold" onclick="location.reload();;">Tạo đơn hàng mới</button>
          </div>
          <div class="col col-md-4 form-group"></div>
          <div class="col col-md-2 form-group float-right">
            <label class="font-weight-bold" for="">Thanh toán trước:</label>
            <input type="text" class="form-control" name="total_discount" onkeyup="getChange(this.value);">
          </div>
          <div class="col col-md-2 form-group float-right">
            <label class="font-weight-bold" for="">Còn nợ:</label>
